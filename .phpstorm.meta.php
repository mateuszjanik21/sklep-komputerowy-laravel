...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.G:\xampp\htdocs\SklepKomputerowy\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.G:\\xampp\\htdocs\\SklepKomputerowy\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'home','dashboard','api.koszyk.dodaj','api.polecane',
'produkty.index','produkty.showPublic','kategorie.index','kontakt.index','kontakt.send',
'koszyk.dodaj','koszyk.index','koszyk.aktualizuj','koszyk.usun','zamowienia.dziekujemy',
'profile.edit','profile.update','profile.destroy','ulubione.index','ulubione.store',
'ulubione.destroy','opinie.store','zamowienia.create','zamowienia.store','api.ulubione.toggle',
'admin.panel','admin.produkty.create','admin.produkty.store','admin.produkty.index','admin.produkty.edit',
'admin.produkty.update','admin.produkty.destroy','admin.produkty.restore','admin.produkty.show','admin.kategorie.index',
'admin.kategorie.create','admin.kategorie.store','admin.kategorie.show','admin.kategorie.edit','admin.kategorie.update',
'admin.kategorie.destroy','admin.atrybuty.storeForCategory','admin.atrybuty.index','admin.atrybuty.edit','admin.atrybuty.update',
'admin.atrybuty.destroy','admin.opinie.index','admin.opinie.toggleStatus','admin.opinie.destroy','admin.zamowienia.index',
'admin.zamowienia.show','admin.zamowienia.zmienStatus','admin.api.kategoria.atrybuty','register',
...
'admin.atrybuty.create','admin.atrybuty.edit','admin.atrybuty.index','admin.kategorie.create','admin.kategorie.edit',
'admin.kategorie.icon-select','admin.kategorie.index','admin.opinie.index','admin.panel','admin.produkty.create',
'admin.produkty.edit','admin.produkty.index','admin.produkty.show','admin.zamowienia.index','admin.zamowienia.show',
...
'home.index','kategorie.index','kontakt.index','koszyk.index','layouts.admin',
'layouts.app','layouts.guest','layouts.navigation','main','produkty.index',
'produkty.show','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'ulubione.index','welcome','zamowienia.create','zamowienia.dziekujemy','laravel-exceptions-renderer::components.card',
